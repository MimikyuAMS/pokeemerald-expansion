...
{//                   Defender -->
 //  Attacker         Normal  Fighting Flying  Poison  Ground   Rock    Bug     Ghost   Steel  Mystery  Fire   Water   Grass  Electric Psychic   Ice   Dragon   Dark   Fairy
    ...
    [TYPE_FIGHTING] = {X(2.0), ______, X(0.5), X(2.0), ______, X(2.0), X(0.5), X(0.0), X(2.0), ______, ______, ______, ______, ______, X(0.5), X(2.0), ______, X(2.0), X(0.5)},
    [TYPE_FLYING]   = {______, X(2.0), ______, ______, X(2.0), X(0.5), X(2.0), ______, X(0.5), ______, ______, ______, X(2.0), X(0.5), ______, ______, ______, ______, ______},
    [TYPE_POISON]   = {X(2.0), X(0.5), ______, X(0.5), X(0.5), X(0.5), X(2.0), X(0.5), X(0.0), ______, ______, X(2.0), X(2.0), ______, ______, ______, ______, ______, X(2.0)},
    ...
    [TYPE_BUG]      = {______, X(0.5), X(0.5), X(0.5), X(2.0), X(0.5), ______, X(0.5), X(0.5), ______, X(0.5), ______, X(2.0), ______, X(2.0), ______, ______, X(2.0), X(0.5)},
#if B_STEEL_RESISTANCES >= GEN_6
    [TYPE_GHOST]    = {X(0.0), X(2.0), ______, ______, ______, ______, ______, X(2.0), ______, ______, ______, ______, ______, ______, X(2.0), ______, ______, X(0.5), ______},
#else
...
#endif
    [TYPE_STEEL]    = {______, X(0.5), ______, ______, ______, X(2.0), ______, ______, X(0.5), ______, X(0.5), X(0.5), ______, X(0.5), ______, X(2.0), X(2.0), ______, X(2.0)},
    ...
    [TYPE_FIRE]     = {______, ______, ______, ______, ______, X(0.5), X(2.0), ______, X(2.0), ______, X(0.5), X(0.5), X(2.0), ______, ______, X(2.0), X(0.5), ______, X(2.0)},
    [TYPE_WATER]    = {______, ______, ______, X(2.0), X(2.0), X(2.0), ______, ______, ______, ______, X(2.0), X(0.5), X(0.5), ______, ______, ______, X(0.5), ______, ______},
    ...
    [TYPE_ELECTRIC] = {______, ______, X(2.0), ______, X(0.0), X(0.5), ______, ______, X(2.0), ______, ______, X(2.0), X(0.5), X(0.5), ______, ______, X(0.5), ______, ______},
    [TYPE_PSYCHIC]  = {______, X(2.0), ______, X(2.0), ______, ______, ______, ______, X(0.5), ______, ______, ______, ______, ______, X(0.5), ______, ______, X(0.0), X(2.0)},
    [TYPE_ICE]      = {______, ______, X(2.0), ______, X(2.0), X(2.0), ______, ______, X(0.5), ______, X(0.5), X(0.5), X(2.0), ______, ______, X(0.5), X(2.0), ______, ______},

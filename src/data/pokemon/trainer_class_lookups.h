const u8 gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_ROCKET_F] = TRAINER_PIC_ROCKET_GRUNT_F,
    [FACILITY_CLASS_ROCKET_M] = TRAINER_PIC_ROCKET_GRUNT_M,
    [FACILITY_CLASS_ROCKET_LEADER] = TRAINER_PIC_ROCKET_GIOVANNI,
};
...
const u8 gFacilityClassToTrainerClass[] =
{
    ...
    [FACILITY_CLASS_ROCKET_M] = TRAINER_CLASS_ROCKET,
    [FACILITY_CLASS_ROCKET_F] = TRAINER_CLASS_ROCKET,
    [FACILITY_CLASS_ROCKET_LEADER] = TRAINER_CLASS_ROCKET_LEADER,
};

...
#if P_FAMILY_OGERPON
#define OGERPON_SPECIES_MISC_INFO(Form, type, ability, color, tera)                          \
    {                                                                                   \
        .baseHP        = 80,                                                            \
        .baseAttack    = 120,                                                           \
        .baseDefense   = 84,                                                            \
    ...
    [SPECIES_OGERPON_TEAL_MASK]             = OGERPON_SPECIES_MISC_INFO(TealMask,        TYPE_GRASS, ABILITY_DEFIANT,                   BODY_COLOR_GREEN, FALSE),
    [SPECIES_OGERPON_WELLSPRING_MASK]       = OGERPON_SPECIES_MISC_INFO(WellspringMask,  TYPE_WATER, ABILITY_WATER_ABSORB,              BODY_COLOR_BLUE, FALSE),
    [SPECIES_OGERPON_HEARTHFLAME_MASK]      = OGERPON_SPECIES_MISC_INFO(HearthflameMask, TYPE_FIRE,  ABILITY_MOLD_BREAKER,              BODY_COLOR_RED, FALSE),
    [SPECIES_OGERPON_CORNERSTONE_MASK]      = OGERPON_SPECIES_MISC_INFO(CornerstoneMask, TYPE_ROCK,  ABILITY_STURDY,                    BODY_COLOR_GRAY, FALSE),
#if P_TERA_FORMS
    [SPECIES_OGERPON_TEAL_MASK_TERA]        = OGERPON_SPECIES_MISC_INFO(TealMask,        TYPE_GRASS, ABILITY_EMBODY_ASPECT_TEAL,        BODY_COLOR_GREEN, TRUE),
    [SPECIES_OGERPON_WELLSPRING_MASK_TERA]  = OGERPON_SPECIES_MISC_INFO(WellspringMask,  TYPE_WATER, ABILITY_EMBODY_ASPECT_WELLSPRING,  BODY_COLOR_BLUE, TRUE),
    [SPECIES_OGERPON_HEARTHFLAME_MASK_TERA] = OGERPON_SPECIES_MISC_INFO(HearthflameMask, TYPE_FIRE,  ABILITY_EMBODY_ASPECT_HEARTHFLAME, BODY_COLOR_RED, TRUE),
    [SPECIES_OGERPON_CORNERSTONE_MASK_TERA] = OGERPON_SPECIES_MISC_INFO(CornerstoneMask, TYPE_ROCK,  ABILITY_EMBODY_ASPECT_CORNERSTONE, BODY_COLOR_GRAY, TRUE),
#endif //P_TERA_FORMS

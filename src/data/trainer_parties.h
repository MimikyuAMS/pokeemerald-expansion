...
static const struct TrainerMon sParty_Felix[] = {
    ...
    .moves = {MOVE_PSYCHIC, MOVE_AURA_SPHERE, MOVE_CALM_MIND, MOVE_RECOVER}
    },
    {
    .lvl = 43,
    .species = SPECIES_CLAYDOL,
    .moves = {MOVE_SKILL_SWAP, MOVE_EARTHQUAKE, MOVE_PSYCHIC, MOVE_CALM_MIND}
    }
};
...
static const struct TrainerMon sParty_Chip[] = {
    ...
    .moves = {MOVE_EARTHQUAKE, MOVE_TRI_ATTACK, MOVE_SAND_ATTACK, MOVE_SUCKER_PUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(6, 6, 6, 6, 6, 6),
    .lvl = 27,
...
static const struct TrainerMon sParty_Jody[] = {
    ...
    .species = SPECIES_ZANGOOSE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SWORDS_DANCE, MOVE_SLASH, MOVE_POISON_JAB, MOVE_SHADOW_CLAW}
    }
};
...
static const struct TrainerMon sParty_Winston5[] = {
    ...
    .species = SPECIES_OBSTAGOON,
    .heldItem = ITEM_NUGGET,
    .moves = {MOVE_FURY_SWIPES, MOVE_CRUNCH, MOVE_OBSTRUCT, MOVE_SAND_ATTACK}
    }
};
...
static const struct TrainerMon sParty_Beau[] = {
    ...
    .lvl = 21,
    .species = SPECIES_TRAPINCH,
    .moves = {MOVE_CRUNCH, MOVE_MUD_SLAP, MOVE_BULLDOZE, MOVE_ROCK_SLIDE}
    }
};
...
static const struct TrainerMon sParty_Sidney[] = {
    ...
    .species = SPECIES_OVERQWIL,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_BARB_BARRAGE, MOVE_CRUNCH, MOVE_TOXIC, MOVE_DESTINY_BOND}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 48,
...
static const struct TrainerMon sParty_Phoebe[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHADOW_CLAW, MOVE_PLAY_ROUGH, MOVE_HONE_CLAWS, MOVE_SHADOW_SNEAK}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 49,
    .species = SPECIES_GENGAR,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHADOW_BALL, MOVE_HEX, MOVE_WILL_O_WISP, MOVE_CURSE}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
...
static const struct TrainerMon sParty_Glacia[] = {
    ...
    .moves = {MOVE_SUPERPOWER, MOVE_BELLY_DRUM, MOVE_ICE_PUNCH, MOVE_U_TURN}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SWORDS_DANCE, MOVE_METAL_CLAW, MOVE_X_SCISSOR, MOVE_NIGHT_SLASH}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 52,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_BLIZZARD, MOVE_AURORA_VEIL, MOVE_HAIL, MOVE_SHADOW_BALL}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 53,
...
static const struct TrainerMon sParty_Drake[] = {
    ...
    .moves = {MOVE_SCALE_SHOT, MOVE_ICE_SHARD, MOVE_GLAIVE_RUSH, MOVE_CRUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 54,
...
static const struct TrainerMon sParty_Wattson1[] = {
    ...
    .moves = {MOVE_MEMENTO, MOVE_SPARK, MOVE_WATER_GUN, MOVE_CHARGE}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 20,
    .species = SPECIES_RAICHU_ALOLAN,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_RISING_VOLTAGE, MOVE_PSYCHIC, MOVE_NASTY_PLOT, MOVE_SURF}
    },
    {
...
static const struct TrainerMon sParty_Flannery1[] = {
    ...
    .moves = {MOVE_ARMOR_CANNON, MOVE_PSYCHIC, MOVE_SHADOW_BALL, MOVE_OVERHEAT}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 24,
    ...
    .moves = {MOVE_OVERHEAT, MOVE_AMNESIA, MOVE_SUNNY_DAY, MOVE_SOLAR_BEAM}
    }
};
...
static const struct TrainerMon sParty_Norman1[] = {
    ...
    .moves = {MOVE_OUTRAGE, MOVE_FACADE, MOVE_EARTHQUAKE, MOVE_HEADBUTT}
    }
};
...
static const struct TrainerMon sParty_Winona1[] = {
    ...
    .species = SPECIES_NOCTOWL,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_MOONBLAST, MOVE_AIR_SLASH, MOVE_ROOST, MOVE_HYPER_BEAM}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 29,
...
static const struct TrainerMon sParty_TateAndLiza1[] = {
    ...
    .moves = {MOVE_HYPER_VOICE, MOVE_MYSTICAL_FIRE, MOVE_PSYCHIC, MOVE_CALM_MIND}
    }, 
};
...
static const struct TrainerMon sParty_Juan1[] = {
    ...
    .moves = {MOVE_CRUNCH, MOVE_AQUA_TAIL, MOVE_ICE_FANG, MOVE_TAUNT}
    }
};
...
static const struct TrainerMon sParty_KateAndJoy[] = {
    ...
    .moves = {MOVE_HYPNOSIS, MOVE_PSYBEAM, MOVE_DIZZY_PUNCH, MOVE_SKILL_SWAP}
    },
    {
    .lvl = 32,
    .species = SPECIES_SLAKING,
...
static const struct TrainerMon sParty_Wallace[] = {
    ...
    .moves = {MOVE_RECOVER, MOVE_NASTY_PLOT, MOVE_STORED_POWER, MOVE_SURF}
    }
};
...
static const struct TrainerMon sParty_Lao1[] = {
    ...
    .moves = {MOVE_SLUDGE_BOMB, MOVE_MINIMIZE, MOVE_MUD_SLAP, MOVE_HARDEN}
    },
    {
    .lvl = 17,
    .species = SPECIES_VENONAT,
    .moves = {MOVE_POISON_POWDER, MOVE_BUG_BUZZ, MOVE_PSYBEAM, MOVE_DISABLE}
    }
};
...
static const struct TrainerMon sParty_Lao2[] = {
    ...
    .moves = {MOVE_TOXIC, MOVE_SLUDGE, MOVE_VENOSHOCK, MOVE_BITE}
    }
};
...
static const struct TrainerMon sParty_Lao5[] = {
    ...
    .species = SPECIES_MUK_ALOLAN,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_TOXIC, MOVE_BELCH, MOVE_VENOSHOCK, MOVE_CRUNCH}
    }
};
...
static const struct TrainerMon sParty_WallyVR1[] = {
    ...
    .moves = {MOVE_SACRED_SWORD, MOVE_SWORDS_DANCE, MOVE_PSYCHO_CUT, MOVE_AQUA_CUTTER}
    }
};
...
static const struct TrainerMon sParty_Roxanne2[] = {
    ...
    .moves = {MOVE_HEAVY_SLAM, MOVE_ROCK_SLIDE, MOVE_PROTECT, MOVE_EARTHQUAKE}
    }
};
...
static const struct TrainerMon sParty_Flannery2[] = {
    ...
    .species = SPECIES_CAMERUPT,
    .heldItem = ITEM_CAMERUPTITE,
    .moves = {MOVE_OVERHEAT, MOVE_SUNNY_DAY, MOVE_EARTHQUAKE, MOVE_ERUPTION}
    },
};
...
static const struct TrainerMon sParty_Rocket1[] = {
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 57,
    .species = SPECIES_GOLBAT,
    .moves = {MOVE_DUAL_WINGBEAT, MOVE_LEECH_LIFE, MOVE_VENOSHOCK, MOVE_STEEL_WING}
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 57,
    .species = SPECIES_RATICATE,
    .moves = {MOVE_CRUNCH, MOVE_DOUBLE_EDGE, MOVE_REVENGE, MOVE_ENDURE}
    },
};

static const struct TrainerMon sParty_Rocket2[] = {
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 57,
    .species = SPECIES_WEEZING,
    .moves = {MOVE_SLUDGE_BOMB, MOVE_TOXIC, MOVE_PSYBEAM, MOVE_DESTINY_BOND}
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 57,
    .species = SPECIES_MUK,
    .moves = {MOVE_SLUDGE_BOMB, MOVE_TOXIC, MOVE_ICE_PUNCH, MOVE_SHADOW_SNEAK}
    },
};

static const struct TrainerMon sParty_Rocket3[] = {
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 57,
    .species = SPECIES_GENGAR,
    .moves = {MOVE_WILL_O_WISP, MOVE_HEX, MOVE_FOCUS_BLAST, MOVE_SLUDGE_BOMB}
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 57,
    .species = SPECIES_ALAKAZAM,
    .moves = {MOVE_CALM_MIND, MOVE_PSYCHIC, MOVE_FOCUS_BLAST, MOVE_DAZZLING_GLEAM}
    },
};

static const struct TrainerMon sParty_Rocket4[] = {
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 57,
    .species = SPECIES_CROBAT,
    .moves = {MOVE_DUAL_WINGBEAT, MOVE_LEECH_LIFE, MOVE_CRUNCH, MOVE_X_SCISSOR}
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 57,
    .species = SPECIES_HONCHKROW,
    .moves = {MOVE_DRILL_PECK, MOVE_U_TURN, MOVE_SUCKER_PUNCH, MOVE_SCREECH}
    },
};

static const struct TrainerMon sParty_RocketAiden[] = {
     {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 75,
    ...
    .moves = {MOVE_SPIKY_SHIELD, MOVE_MORTAL_SPIN, MOVE_ENERGY_BALL, MOVE_EARTH_POWER}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 75,
    ...
    .moves = {MOVE_EXTREME_SPEED, MOVE_OUTRAGE, MOVE_DRAGON_DANCE, MOVE_ICE_SPINNER}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 75,
    ...
    .moves = {MOVE_VOLT_SWITCH, MOVE_HYDRO_PUMP, MOVE_PROTECT, MOVE_WILL_O_WISP}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 75,
    ...
    .moves = {MOVE_BLAZE_KICK, MOVE_SWORDS_DANCE, MOVE_KNOCK_OFF, MOVE_CLOSE_COMBAT}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 75,
    ...
    .moves = {MOVE_PLAY_ROUGH, MOVE_WOOD_HAMMER, MOVE_SHADOW_CLAW, MOVE_SHADOW_SNEAK}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 75,
    .species = SPECIES_GARDEVOIR,
    .heldItem = ITEM_GARDEVOIRITE,
    .moves = {MOVE_HYPER_VOICE, MOVE_PSYCHIC, MOVE_AURA_SPHERE, MOVE_CALM_MIND}
    },
};

static const struct TrainerMon sParty_Square[] = {
     {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 75,
    ...
    .moves = {MOVE_DAZZLING_GLEAM, MOVE_MYSTICAL_FIRE, MOVE_CALM_MIND, MOVE_GIGA_DRAIN}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 75,
    ...
    .moves = {MOVE_SANDSTORM, MOVE_IRON_HEAD, MOVE_EARTHQUAKE, MOVE_ROCK_SLIDE}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 75,
    ...
    .heldItem = ITEM_FOCUS_SASH,
    .moves = {MOVE_BITTER_BLADE, MOVE_HEX, MOVE_WILL_O_WISP, MOVE_DESTINY_BOND}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 75,
    ...
    .moves = {MOVE_SANDSTORM, MOVE_FOCUS_BLAST, MOVE_ROCK_POLISH, MOVE_IRON_TAIL}
    },
};

static const struct TrainerMon sParty_ZeeRoh[] = {
     {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 75,
    .species = SPECIES_MAGNEZONE,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_SPIKES, MOVE_BODY_PRESS, MOVE_SYNTHESIS, MOVE_STONE_EDGE}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 75,
    ...
    .moves = {MOVE_EARTHQUAKE, MOVE_PROTECT, MOVE_KNOCK_OFF, MOVE_TOXIC}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 75,
    ...
    .heldItem = ITEM_HEAVY_DUTY_BOOTS,
    .moves = {MOVE_BUG_BUZZ, MOVE_HURRICANE, MOVE_TAIL_GLOW, MOVE_ROOST}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 75,
    ...
    .ability = ABILITY_ADAPTABILITY,
    .heldItem = ITEM_LIFE_ORB,
    .moves = {MOVE_CRABHAMMER, MOVE_KNOCK_OFF, MOVE_SWORDS_DANCE, MOVE_AQUA_JET}
    },
};

static const struct TrainerMon sParty_Deestar[] = {
     {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 75,
    .species = SPECIES_OGERPON_HEARTHFLAME,
    .heldItem = ITEM_HEARTHFLAME_MASK,
    .moves = {MOVE_IVY_CUDGEL, MOVE_SWORDS_DANCE, MOVE_U_TURN, MOVE_TRAILBLAZE}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 75,
    ...
    .moves = {MOVE_CLOSE_COMBAT, MOVE_LIQUIDATION, MOVE_CRUNCH, MOVE_ICE_FANG}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 75,
    ...
    .moves = {MOVE_PROTECT, MOVE_FACADE, MOVE_HEADLONG_RUSH, MOVE_SHADOW_CLAW}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 75,
    ...
    .moves = {MOVE_CHLOROBLAST, MOVE_TAUNT, MOVE_VOLT_SWITCH, MOVE_FOUL_PLAY}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 75,
    .species = SPECIES_METAGROSS,
    .ability = ABILITY_CLEAR_BATTLE,
    .heldItem = ITEM_WEAKNESS_POLICY,
    .moves = {MOVE_METEOR_MASH, MOVE_THUNDER_PUNCH, MOVE_ICE_PUNCH, MOVE_ZEN_HEADBUTT}
    },
};

static const struct TrainerMon sParty_Bonk[] = {
     {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 75,
    .species = SPECIES_NINETALE_ALOLAN,
    ...
    .moves = {MOVE_SCALD, MOVE_HAZE, MOVE_ICE_BEAM, MOVE_RECOVER}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 75,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_SHADOW_SNEAK, MOVE_IRON_HEAD, MOVE_KINGS_SHIELD, MOVE_SWORDS_DANCE}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 75,
    ...
    static const struct TrainerMon sParty_Yume[] = {
     {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 75,
    .species = SPECIES_OVERQWIL,
    ...
    .moves = {MOVE_SWORDS_DANCE, MOVE_SCALE_SHOT, MOVE_CRUNCH, MOVE_BARB_BARRAGE}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 75,
    ...
    .heldItem = ITEM_FOCUS_SASH,
    .ability = ABILITY_WEAK_ARMOR,
    .moves = {MOVE_BITTER_BLADE, MOVE_SWORDS_DANCE, MOVE_POLTERGEIST, MOVE_SHADOW_SNEAK}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 75,
    ...
    .heldItem = ITEM_WHITE_HERB,
    .moves = {MOVE_ACROBATICS, MOVE_CLOSE_COMBAT, MOVE_DIRE_CLAW, MOVE_SWORDS_DANCE}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 75,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_BELLY_DRUM, MOVE_AQUA_JET, MOVE_PLAY_ROUGH, MOVE_ICE_SPINNER}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 75,
    ...
    .moves = {MOVE_SHADOW_BALL, MOVE_THUNDERBOLT, MOVE_DAZZLING_GLEAM, MOVE_DARK_PULSE}
    },
};
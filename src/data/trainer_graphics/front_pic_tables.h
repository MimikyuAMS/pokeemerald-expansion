const struct MonCoords gTrainerFrontPicCoords[] =
{
    ...
    [TRAINER_PIC_ROCKET_GIOVANNI] = {.size = 8, .y_offset = 1},
...
const struct CompressedSpriteSheet gTrainerFrontPicTable[] =
{
    ...
    TRAINER_SPRITE(ROCKET_GIOVANNI, gTrainerFrontPic_RocketGiovanni, TRAINER_PIC_SIZE),
...
const struct CompressedSpritePalette gTrainerFrontPicPaletteTable[] =
{
    ...
    TRAINER_PAL(ROCKET_GIOVANNI, gTrainerPalette_RocketGiovanni),

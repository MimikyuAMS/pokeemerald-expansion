...
const u32 gTrainerFrontPic_RocketGiovanni[] = INCBIN_U32("graphics/trainers/front_pics/rocket_giovanni.4bpp.lz");
const u32 gTrainerPalette_RocketGiovanni[] = INCBIN_U32("graphics/trainers/front_pics/rocket_giovanni.gbapal.lz");

...
#define SSTIDAL_SELECTION_TRINITY_ARCHIPELAGO 6
...
#define STDSTRING_MEGASTONES         16
#define STDSTRING_POKEBALLS        17
#define STDSTRING_TMHMS            18
#define STDSTRING_BERRIES          19
